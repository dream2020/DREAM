 /** @file userModelDriverYarpInterface.h 
  *
  * Version 1.0
  * 
...
#ifndef USERMODELDRIVERYARPINTERFACE
#define USERMODELDRIVERYARPINTERFACE
...
class UserModelDriverThread;
class UserModelDriverController;

class UserModelDriverYarpInterface{
private:
	UserModelDriverThread* _yarpThread;
   UserModelDriverController* _controller;
public:
	/* class methods */
	UserModelDriverYarpInterface();
	void init(UserModelDriverThread* yarpThread, UserModelDriverController* controller);
	void getFromUserData(Bottle data);
