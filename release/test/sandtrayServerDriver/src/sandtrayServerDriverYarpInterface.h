 /** @file sandtrayServerDriverYarpInterface.h 
  *
  * Version 1.0
  * 
...
#ifndef SANDTRAYSERVERDRIVERYARPINTERFACE
#define SANDTRAYSERVERDRIVERYARPINTERFACE
...
class SandtrayServerDriverThread;
class SandtrayServerDriverController;

class SandtrayServerDriverYarpInterface{
private:
	SandtrayServerDriverThread* _yarpThread;
	SandtrayServerDriverController* _controller;
public:
	/* class methods */
	SandtrayServerDriverYarpInterface();
	void init(SandtrayServerDriverThread* yarpThread, SandtrayServerDriverController* controller);
