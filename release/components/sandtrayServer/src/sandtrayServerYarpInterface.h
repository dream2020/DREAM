 /** @file sandtrayServerYarpInterface.h 
  *
  * Version 1.0
  * 
...
#ifndef SANDTRAYSERVERYARPINTERFACE
#define SANDTRAYSERVERYARPINTERFACE
...
class SandtrayServerThread;
class SandtrayServerController;

class SandtrayServerYarpInterface{
private:
	SandtrayServerThread* _yarpThread;
   SandtrayServerController* _controller;
public:
	/* class methods */
	SandtrayServerYarpInterface();
	~SandtrayServerYarpInterface();
	void init(SandtrayServerThread* yarpThread, SandtrayServerController* controller);
